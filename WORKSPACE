...
new_local_repository(
    ...
    path="/home/colivier/src/hmdeepstream/deepstream/sources/apps/apps-common",
    # path="/opt/nvidia/deepstream/deepstream/sources/apps/apps-common",
    build_file = "@//build:third_party/deepstream_apps_common.BUILD"
)
