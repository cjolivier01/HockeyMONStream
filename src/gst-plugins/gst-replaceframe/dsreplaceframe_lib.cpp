...
struct DsReplaceFrameCtx {
  DsReplaceFrameInitParams initParams;
...
void prune_detection_boxes(NvDsFrameMeta* frame_meta, const DsReplaceFrameCtx* ctx) {
...
DsReplaceFrameCtx* DsReplaceFrameCtxInit(DsReplaceFrameInitParams* initParams) {
  DsReplaceFrameCtx* ctx = new DsReplaceFrameCtx();
