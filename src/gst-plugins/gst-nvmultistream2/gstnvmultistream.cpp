...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,
    GST_VERSION_MINOR,
    nvdsgst_multistream,
    DESCRIPTION, plugin_init, "7.1", LICENSE, BINARY_PACKAGE, URL)
#endif
...
gboolean gGstNvMultistream2StaticInit()
{
  return gst_plugin_register_static(GST_VERSION_MAJOR, GST_VERSION_MINOR,
                 "nvdsgst_multistream",
                 DESCRIPTION, plugin_init_2, "7.1", LICENSE, BINARY_PACKAGE, PACKAGE, URL);
}
#endif
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,
    GST_VERSION_MINOR,
    nvdsgst_multistream,
    DESCRIPTION, plugin_init_2, "7.1", LICENSE, BINARY_PACKAGE, URL)
