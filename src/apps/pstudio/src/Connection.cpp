...
{
    return m_srcElement == other.m_srcElement &&
           m_srcPad == other.m_srcPad &&
           m_dstElement == other.m_dstElement &&
           m_dstPad == other.m_dstPad;
}

QString Connection::toString() const
{
    return m_srcElement + "." + m_srcPad + " -> " + 
           m_dstElement + "." + m_dstPad;
}
