...
// and their files. The UI confirms removal of completed results and all affected
// dependents first. Refuses active/quarantined process intent and surviving dependencies.
