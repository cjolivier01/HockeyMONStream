...
WINDOWS_INSTALLER_REPOSITORY ?= cjolivier01/HockeyMONStream
WINDOWS_SIGNING_PKCS12 ?=
WINDOWS_SIGNING_PASSWORD_FILE ?=
WINDOWS_SIGNING_CA_FILE ?=
...
windows-installer:
	...
	WINDOWS_SIGNING_TIMESTAMP_URL="$(WINDOWS_SIGNING_TIMESTAMP_URL)" \
